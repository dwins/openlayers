  ...
  /********************************************************/
   ...
   /** 
    ...
    moveByPx: function(dx, dy) {
        ...
        var x = hw + dx;
        var y = hh + dy;
        var wrapDateLine = this.wrapDateLine();
        var xRestriction = 0;
        var yRestriction = 0;
     ...
     *
     * Returns:
     * {Boolean} Are we wrapping the date line? Will be true if wrapDateLine is
     *     set to true on the base layer and the map is not wider than one
     *     world.
     */
    wrapDateLine: function() {
        var extent = this.getExtent(),
        wrapDateLine = this.baseLayer && this.baseLayer.wrapDateLine;
        if (wrapDateLine && extent) {
            var maxWidth = this.getMaxExtent().getWidth(),
                currentWidth = extent.getWidth();
            wrapDateLine = currentWidth <= maxWidth;
        }
        return wrapDateLine;
    },
    ...
    isValidLonLat: function(lonlat) {
        ...
        if (lonlat != null) {
            ...
            var worldBounds = this.wrapDateLine() && maxExtent;
