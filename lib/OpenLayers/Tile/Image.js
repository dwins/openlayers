...
OpenLayers.Tile.Image = OpenLayers.Class(OpenLayers.Tile, {
    ...
    setImgSrc: function(url) {
        var img = this.imgDiv,
            crossOriginKeyword = this.crossOriginKeyword;
        OpenLayers.Animation.requestFrame(function() {
            img.style.visibility = 'hidden';
            img.style.opacity = 0;
            if (url) {
                // don't set crossOrigin if the url is a data URL
                if (crossOriginKeyword) {
                    if (url.substr(0, 5) !== 'data:') {
                        img.setAttribute("crossorigin", crossOriginKeyword);
                    } else {
    ...
    onImageLoad: function() {
        ...
        OpenLayers.Animation.requestFrame(function() {
            ...
            img.style.opacity = that.layer.opacity;

            that.isLoading = false;
            that.canvasContext = null;
